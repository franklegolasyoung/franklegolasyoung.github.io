...
export function MapMyVisitors() {
  ...
  useEffect(() => {
    ...
    script.src = `https://mapmyvisitors.com/map.js?cl=16A8D9&w=${containerWidth}&t=n&d=7I1ySOZzz6_tws4Fp2G7ErX6SwjarouXvh-HoqgzBlU&co=${co}&cmo=80CED7&cmn=ff1e1e&ct=808080`
